...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn('p-3 bg-primary ', className)}
      classNames={{
        ...
        day_selected:
          'bg-primary-text text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary-text focus:text-primary-foreground',
